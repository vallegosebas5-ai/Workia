...
# Railway MySQL plugin usa MYSQLHOST, MYSQLPORT, MYSQLDATABASE, MYSQLUSER, MYSQLPASSWORD
DB_HOST_VALUE="${MYSQLHOST:-${DB_HOST:-127.0.0.1}}"
DB_PORT_VALUE="${MYSQLPORT:-${DB_PORT:-3306}}"
DB_DATABASE_VALUE="${MYSQLDATABASE:-${MYSQL_DATABASE:-${DB_DATABASE:-workia}}}"
DB_USERNAME_VALUE="${MYSQLUSER:-${DB_USERNAME:-root}}"
DB_PASSWORD_VALUE="${MYSQLPASSWORD:-${DB_PASSWORD}}"
